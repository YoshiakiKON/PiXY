...
- License: MIT
- Last updated: 2026-08-18 (v1.5.3 spec)

---

## Version Notes (v1.5.3)
...
**Manual Version**: 1.5.3  
**Last Updated**: 2026-08-18  
**Status**: Release

### TODO for v1.5.3 Release

- [x] Update version number in this manual (currently "1.5.3 Release")
...
- [x] Commit to git and tag as `v1.5.3`
